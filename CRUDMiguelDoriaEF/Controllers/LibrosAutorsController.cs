...
namespace CRUDMiguelDoriaEF.Controllers
{
    public class LibrosAutorsController : Controller
    {
        ...
        public LibrosAutorsController(CrudmiguelUrangoEfContext context)
        {
            _context = context;
        }
        ...
        {
            var crudmiguelUrangoEfContext = _context.LibrosAutors.Include(l => l.IdAutorNavigation).Include(l => l.IsbnNavigation);
