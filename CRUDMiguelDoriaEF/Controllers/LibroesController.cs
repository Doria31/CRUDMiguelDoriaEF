...
using CRUDMiguelDoriaEF.Models;

namespace CRUDMiguelDoriaEF.Controllers
{
    public class LibroesController : Controller
    {
        private readonly CrudmiguelUrangoEfContext _context;

        public LibroesController(CrudmiguelUrangoEfContext context)
        {
            _context = context;
        }
        ...
        {
            var crudmiguelUrangoEfContext = _context.Libros.Include(l => l.CodigoCategoriaNavigation).Include(l => l.NitEditorialNavigation);
            return View(await crudmiguelUrangoEfContext.ToListAsync());
        }
